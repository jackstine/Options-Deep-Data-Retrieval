...
class StockMarketProvider(BaseProvider):
    ...
    industries = [
        'Software', 'Biotechnology', 'Banks', 'Retail', 'Aerospace & Defense',
        'Semiconductors', 'Pharmaceuticals', 'Insurance', 'Oil & Gas',
        'Telecommunications', 'Automotive', 'Food & Beverage', 'Mining'
    ]
    ...
    def stock_price(self):
        ...
        if category == 'penny':
            return round(self.generator.random.uniform(0.01, 5.00), 2)
        elif category == 'low':
            return round(self.generator.random.uniform(5.00, 25.00), 2)
        elif category == 'medium':
            return round(self.generator.random.uniform(25.00, 100.00), 2)
        elif category == 'high':
            return round(self.generator.random.uniform(100.00, 500.00), 2)
        else:  # premium
            return round(self.generator.random.uniform(500.00, 5000.00), 2)
    ...
    def pe_ratio(self):
        ...
        return round(self.generator.random.uniform(5.0, 50.0), 2)
    
    def dividend_yield(self):
        """Generate a realistic dividend yield percentage."""
        return round(self.generator.random.uniform(0.0, 8.0), 2)
    
    def beta(self):
        """Generate a realistic stock beta value."""
        return round(self.generator.random.uniform(0.1, 3.0), 2)
    
    def earnings_per_share(self):
        """Generate realistic earnings per share."""
        return round(self.generator.random.uniform(-5.0, 25.0), 2)
