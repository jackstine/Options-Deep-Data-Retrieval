#!/usr/bin/env python3
"""Command-line tool for daily low/high pattern calculation.
...
Usage:
    # Run for today
    python -m src.cmd.algorithms.daily_low_high_calculation

    # Run for specific date
    python -m src.cmd.algorithms.daily_low_high_calculation --date 2024-01-15
...
def main() -> None:
    """Run daily low/high calculation."""
    parser = argparse.ArgumentParser(
        description="Calculate daily low/high patterns for all active patterns",
...
Examples:
  ...
  Run for specific date:
    ...
    # Print result
    logger.info("=" * 60)
    logger.info("DAILY LOW/HIGH CALCULATION RESULT")
    logger.info("=" * 60)
