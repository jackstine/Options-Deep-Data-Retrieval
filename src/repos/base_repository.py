...
from typing import TypeVar, Generic, List, Optional, Set, Dict, Any, Type, Callable
from dataclasses import dataclass, fields
from datetime import date
from sqlalchemy import create_engine, select, update, delete, func, or_, and_
...
class BaseRepository(Generic[TDataModel, TDBModel], ABC):
    ...
    def _apply_text_search(self, stmt, text_query: str, search_fields: List[str] = None):
        ...
        try:
            with self._SessionLocal() as session:
                ...
                if options.text_search:
                    query = self._apply_text_search(query, options.text_search, options.text_search_fields)
