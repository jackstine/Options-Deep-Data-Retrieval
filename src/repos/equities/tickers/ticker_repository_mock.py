...
class TickerRepositoryMock:
    ...
    def __init__(self, seed: int = 12345):
        ...
        self._company_tickers: dict[
            int, list[int]
        ] = {}  # company_id -> list of ticker_ids
    ...
    def get(self, filter_model: TickerDataModel | None = None) -> list[TickerDataModel]:
    ...
    def get_one(self, filter_model: TickerDataModel) -> TickerDataModel | None:
        """Get single ticker matching filter."""
        results = self.get(filter_model)
        return results[0] if results else None

    def get_by_id(self, id: int) -> TickerDataModel | None:
        """Get ticker by ID."""
        return self._tickers.get(id)

    def count(self, filter_model: TickerDataModel | None = None) -> int:
    ...
    def insert(self, data_model: TickerDataModel) -> TickerDataModel:
        ...
        logger.info(
            f"Mock: Inserted ticker {data_model.symbol} with ID {data_model.id}"
        )
        return data_model
    ...
    def update(
        self, filter_model: TickerDataModel, update_data: TickerDataModel
    ) -> int:
    ...
    def add_fake_tickers(
        self, count: int = 5, company_id: int | None = None
    ...
    def get_symbols_starting_with(self, prefix: str) -> list[str]:
        ...
        return [
            symbol
            for symbol in self._symbol_to_ticker.keys()
